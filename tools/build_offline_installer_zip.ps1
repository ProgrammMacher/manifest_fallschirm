...
$packageName = "manifest_offline_installer_$timestamp"
...
$metaFile = Join-Path $stagingRoot 'OFFLINE_INSTALLER_CONTENTS.txt'
@(
    "Paket: $packageName"
...
Write-Host ''
Write-Host 'Offline-Installer-ZIP erfolgreich erstellt.'
Write-Host "ZIP: $zipPath"
Write-Host "Groesse: $sizeMB MB"
Write-Host "Staging: $stagingRoot"
Write-Host ''
Write-Host 'Hinweis: Das Skript verwendet ausschliesslich Pfade innerhalb des Projektordners.'