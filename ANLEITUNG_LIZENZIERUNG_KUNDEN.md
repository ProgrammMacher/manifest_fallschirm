...
1. **Installer-Datei (als Anhang):**
   ```
   C:\manifest_fallschirm\build\installer\manifest_ou_1_1.exe
   ```
...
>
> anbei finden Sie:
> - `manifest_ou_1_1.exe` – Der Installer für Manifest Fallschirm
...
| **Installer für Kunde** | `manifest_ou_1_1.exe` | `C:\manifest_fallschirm\build\installer\manifest_ou_1_1.exe` |
...
Wie im Web-UI Workflow: Kopieren und an Kunde versenden (mit `manifest_ou_1_1.exe`)
...
>
> **Anhänge:**
> - `manifest_ou_1_1.exe` – Der Installer
> - `lizenzschluessel.txt` – Ihr persönlicher Lizenzschlüssel
>
> **Installationsschritte:**
>
...
> 3. Doppelklick auf `manifest_ou_1_1.exe`
...
- Doppelklick auf `manifest_ou_1_1.exe`
...
3. manifest_ou_1_1.exe doppelklicken
...
| **Installer für Kunde** | `C:\manifest_fallschirm\build\installer\manifest_ou_1_1.exe` |
...
| **Phase 3** | `manifest_ou_1_1.exe` | Zu Kunde | Per E-Mail schicken |
